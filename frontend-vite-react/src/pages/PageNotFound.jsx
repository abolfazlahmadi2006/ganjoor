      ...
      <div class="w-full flex-col justify-start items-center lg:gap-16 gap-10 inline-flex lg:pt-[180px] pt-12 lg:pb-28 pb-12">
        <div>
          ...
          <div class="relative h-[calc(550px-85px)] flex justify-center items-center flex-col">
            ...
            >
              <path
                d="M 132 132 Z Z M 43.4542 138.063 V 138.563 H 43.9542 H 62.7222 H 63.2222 V 138.063 V 123.331 H 71.4262 H 71.9262 V 122.831 V 105.559 V 105.059 H 71.4262 H 63.2222 V 81.0785 V 80.5785 H 62.7222 H 43.9542 H 43.4542 V 81.0785 V 105.059 H 23.3911 L 53.9264 40.3559 L 54.2631 39.6425 H 53.4742 H 32.2582 H 31.9413 L 31.8061 39.9291 L 0.9341 105.345 L 0.8862 105.446 V 105.559 V 122.831 V 123.331 H 1.3862 H 43.4542 V 138.063 Z Z M 284.642 138.063 V 138.563 H 285.142 H 303.91 H 304.41 V 138.063 V 123.331 H 312.614 H 313.114 V 122.831 V 105.559 V 105.059 H 312.614 H 304.41 V 81.0785 V 80.5785 H 303.91 H 285.142 H 284.642 V 81.0785 V 105.059 H 264.579 L 295.114 40.3559 L 295.451 39.6425 H 294.662 H 273.446 H 273.129 L 272.994 39.9291 L 242.122 105.345 L 242.074 105.446 V 105.559 V 122.831 V 123.331 H 242.574 H 284.642 V 138.063 Z"
                fill="#3564fc"
                fillOpacity="0.10"
                stroke="#4F46E5"
              />
            ...
            <div class="block text-center mt-5">
              <h5 class="md:text-xl text-lg leading-8font-medium mb-1.5">
                <span class="text-indigo-600 dark:text-indigo-500 font-semibold ">
                  آخ!
                </span>
                <span>به نظر می‌رسه این صفحه وجود نداره 🫤</span>
              </h5>
              <p class="text-sm text-gray-500">ما داریم روش کار می‌کنیم 😉</p>
            </div>
          </div>
        </div>
      </div>
